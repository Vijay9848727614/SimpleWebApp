...
<body>
    ...
    <section id="home">
        <header>
            <span style="font-size:64px;margin-right:10px;color:orange">Flipkart Server Working Now today EOD 7PM</span>
            <ul id="menu">
         ...
         <h1>Diwali offers avalable till NewYear Upto 220%</h1>   
